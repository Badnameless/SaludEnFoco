            ...
            <div class="bg-white rounded-md max-w-[65%] mx-auto">
                ...
                <div class="p-6 px-0 grid grid-cols-1 fieldsContainer">
                    ...
                    <div class="flex justify-between px-12 py-8 border-b border-gray-200">
                        ...
                        <div class="w-full">
                            <input value="{{ $blog->nombre }}" type="text" name="nombre" class="w-full border border-gray-200 px-4 py-[8px] box-border rounded text-md" required>
                        </div>
                    </div>
                    <div class="flex justify-between px-12 py-8 border-b border-gray-200">
                        <label class="text-[16px] font-medium leading-thing mr-2 flex items-center w-[250px]" for="descripcion">Descripcion</label>
                        <div class="w-full">
                            <textarea name="descripcion" cols="30" rows="16" class="w-full min-h-[150px] border border-gray-200 px-4 py-[8px] box-border rounded text-md" required>{{ old('descripcion', $blog->descripcion) }}</textarea>
                        </div>
                    </div>
                    <div class="flex justify-between px-12 py-8 border-b border-gray-200">
                        <label class="text-[16px] font-medium leading-thing mr-2 flex items-center w-[250px]" for="sintomas">Sintomas</label>
                        <div class="w-full">
                            <textarea  name="sintomas" cols="30" rows="16" class="w-full min-h-[150px] border border-gray-200 px-4 py-[8px] box-border rounded text-md" required>{{ old('sintomas', $blog->sintomas) }}</textarea>
                        </div>
                    </div>
                    <div class="flex justify-between px-12 py-8 border-b border-gray-200">
                        <label class="text-[16px] font-medium leading-thing mr-2 flex items-center w-[250px]" for="causas">Causas</label>
                        <div class="w-full">
                            <textarea name="causas" cols="30" rows="16" class="w-full min-h-[150px] border border-gray-200 px-4 py-[8px] box-border rounded text-md" required>{{ old('causas', $blog->causas) }}</textarea>
                        </div>
                    </div>
                    <div class="flex justify-between px-12 py-8 border-b border-gray-200">
                        <label class="text-[16px] font-medium leading-thing mr-2 flex items-center w-[250px]" for="prevencion">Prevención</label>
                        <div class="w-full">
                            <textarea name="prevencion" cols="30" rows="16" class="w-full min-h-[150px] border border-gray-200 px-4 py-[8px] box-border rounded text-md" required>{{ old('prevencion', $blog->prevencion) }}</textarea>
                        </div>
                    </div>
                    <div class="flex justify-between px-12 py-8 border-b border-gray-200">
                        <label class="text-[16px] font-medium leading-thing mr-2 flex items-center w-[250px]" for="vistas">Vistas</label>
                        <div class="w-full">
                            <input type="number" name="vistas" step="any" value="{{ old('views', $blog->views) }}" class="w-full border border-gray-200 px-4 py-[8px] box-border rounded text-md" required>
                        </div>
                    </div>
                    <div class="flex justify-between px-12 py-8 border-b border-gray-200">
                        <label class="text-[16px] font-medium leading-thing mr-2 flex items-center w-[250px]" for="fecha">Fecha</label>
                        <div class="w-full">
                            <input type="date" value="{{ old('fecha', $blog->fecha) }}" name="fecha" id="fecha" value="{{ old('fecha') }}" class="w-full border border-gray-200 px-4 py-[8px] box-border rounded text-md" required>
                        </div>
                    </div>
