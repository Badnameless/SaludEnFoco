...
<div class="importsContainer bg-gray-100">
    ...
    <div class="py-6 px-4 sm:px-6 lg:px-8 px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-lg">
            ...
            <form method="POST" enctype="multipart/form-data" action="{{route('form_import')}}">
                @csrf
            <div class="max-w-screen-2xl mx-auto pt-8 px-6">
                ...
                <div>
                    ...
                    <div class="mb-6">
                        ...
                        <a href="{{route('example-simple')}}" class="px-4 py-3 text-md rounded-md bg-mundoVerdeGreen hover:bg-mundoVerdeDarkGreen duration-300 text-white">
