            ...
            <div class="bg-white rounded-md max-w-[65%] mx-auto">
                ...
                <div class="p-6 px-0 grid grid-cols-1 fieldsContainer">
                        ...
                        <div class="w-full">
                            <select name="TipoEventoID" id="Tipo" class="w-full border border-gray-200 px-4 py-[8px] box-border rounded text-md" required>
                                ...
                                @foreach($tipos as $tipo)
                                    <option value="{{ $tipo->TipoEventoID }}" {{ old('TipoEventoID') == $tipo->TipoEventoID ? 'selected' : '' }}>{{ $tipo->Nombre }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="flex justify-between px-12 py-8 border-b border-gray-200">
                        ...
                        <div class="w-full">
                            <input type="text" name="Lugar" id="lugar" value="{{ old('Lugar') }}" class="w-full border border-gray-200 px-4 py-[8px] box-border rounded text-md" required>
                        </div>
                    </div>
                    ...
                    <div class="flex justify-between px-12 py-8 border-b border-gray-200">
                        ...
                        <div class="w-full">
                            <input type="datetime-local" name="FechaHora" id="fechaHora" value="{{ old('FechaHora') }}" class="w-full border border-gray-200 px-4 py-[8px] box-border rounded text-md" required>
                        </div>
                    </div>
                    ...
                    <div class="flex justify-between px-12 py-8 border-b border-gray-200">
                        ...
                        <div class="w-full">
                            <input type="number" step="any" name="Longitud" id="longitud" value="{{ old('Longitud') }}"  class="w-full border border-gray-200 px-4 py-[8px] box-border rounded text-md">
                        </div>
                    </div>
