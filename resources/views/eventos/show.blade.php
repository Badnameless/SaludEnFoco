        ...
        <div class="bg-white rounded-md max-w-[65%] mx-auto">
            ...
            <div class="p-6 px-0 grid grid-cols-1 fieldsContainer">
                <div class="flex justify-between px-12 py-8 border-b border-gray-200">
                    <center><b><p>El evento seleccionado no existe, o hubo un error al mostrarlo.</p></b></center>
                </div>
            </div>
            @else
                <div class="p-6 px-0 grid grid-cols-1 fieldsContainer">
                    ...
                    <div class="flex justify-between px-12 py-8 border-b border-gray-200">
                        ...
                        <div class="w-full">
                            <span class="border border-gray-200 px-4 py-[8px] box-border rounded text-md">{{$evento->Nombre}}</span>
                        </div>
                    </div>
                    <!-- Campo ProvinciaID -->
                    <div class="flex justify-between px-12 py-8 border-b border-gray-200">
                        ...
                        <div class="w-full">
                            <span class="border border-gray-200 px-4 py-[8px] box-border rounded text-md">{{$evento->provincia->Nombre}}</span>
                        </div>
                    </div>
                    <!-- Campo Tipo -->
                    <div class="flex justify-between px-12 py-8 border-b border-gray-200">
                        ...
                        <div class="w-full">
                            <span class="border border-gray-200 px-4 py-[8px] box-border rounded text-md">{{$evento->tipoEvento->Nombre}}</span>
                        </div>
                    </div>
                    <!-- Campo Descripción -->
                    <div class="flex justify-between px-12 py-8 border-b border-gray-200">
                    ...
                    <div class="flex justify-between px-12 py-8 border-b border-gray-200">
                        ...
                        <div class="w-full">
                            <span class="border border-gray-200 px-4 py-[8px] box-border rounded text-md">{{$evento->FechaHora}}</span>
                        </div>
                    </div>
                    <!-- Campo Lugar -->
                    <div class="flex justify-between px-12 py-8 border-b border-gray-200">
                        ...
                        <div class="w-full">
                            <span class="border border-gray-200 px-4 py-[8px] box-border rounded text-md">{{$evento->Lugar}}</span>
                        </div>
                    </div>
                    <!-- Campo Latitud -->
                    <div class="flex justify-between px-12 py-8 border-b border-gray-200">
                        ...
                        <div class="w-full">
                            <span class="border border-gray-200 px-4 py-[8px] box-border rounded text-md">{{$evento->Latitud}}</span>
                        </div>
                    </div>
                    <!-- Campo Longitud -->
                    <div class="flex justify-between px-12 py-8 border-b border-gray-200">
                        ...
                        <div class="w-full">
                            <span class="border border-gray-200 px-4 py-[8px] box-border rounded text-md">{{$evento->Longitud}}</span>
                        </div>
                    </div>
                    ...
                    <div class="flex justify-between px-12 py-8 border-b border-gray-200">
                        ...
                        <div class="w-full">
                            <img src="{{ asset('storage/eventos/' . $evento->Imagen) }}" alt="{{$evento->Nombre}}" class="mt-4 mb-4">
                        </div>
                    </div>
                    <div class="flex justify-between px-12 py-8 border-b border-gray-200">
