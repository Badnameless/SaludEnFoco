                              ...
                              <tr>
                                ...
                                <td class="w-1/4 whitespace-nowrap py-2 pl-4 pr-3 text-sm font-medium text-mundoVerdeGreen sm:pl-6 hover:underline">
                                  <div class="flex items-center">
                                      ...
                                      {{-- <script>
                                          let publishTag = document.querySelector("#publish_brand").checked;
                                          document.querySelector("#publish_brand").value = publishTag;
                                          document.querySelector("#publish_brand").addEventListener("change", ()=>{
                                              let publishTag = document.querySelector("#publish_brand").checked;
                                              document.querySelector("#publish_brand").value = publishTag;
                                          })
                                      </script> --}}
                                ...
                                <td class="relative whitespace-nowrap py-4 pl-3 pr-4 sm:pr-6">
                                  <div class="flex items-center">
                                      <a href="{{ route('provinces.edit', $provincia->ProvinciaID) }}">
                                      ...
                                      <div>
                                        <form action="{{ route('provinces.destroy', $provincia->ProvinciaID) }}" method="POST">
