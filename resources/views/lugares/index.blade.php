...
@section('content')
    ...
    <div class="max-w-screen-2xl w-full mx-auto px-4 sm:px-6 lg:px-8 px-4 sm:px-6 lg:px-8 mt-12">
        ...
        <form action="{{route('places.show', 1)}}" method="get" class="flex items-center gap-5 w-full mt-12">
                            ...
                            @foreach($lugares as $lugar)
                              <tr>
                                ...
                                <td class="relative whitespace-nowrap py-4 pl-3 pr-4 sm:pr-6">
                                  <div class="flex items-center">
                                      <a href="{{ route('places.edit', $lugar->LugarID) }}">
                                      ...
                                      <div>
                                        <form action="{{ route('places.destroy', $lugar->LugarID) }}" method="POST">
