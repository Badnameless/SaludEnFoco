...
@section('content')
    ...
    <div class="max-w-screen-2xl w-full mx-auto px-4 sm:px-6 lg:px-8 px-4 sm:px-6 lg:px-8 mt-12">
        ...
        <form action="{{ route('provinces.show', 1) }}" method="get" class="flex items-center gap-5 w-full mt-12">
        ...
        <div class="bg-white rounded-md">
            <div class="mb-4 flex items-center justify-end px-8 pt-8">
                <a href="{{ route('frecuent-questions.create') }}">
                            ...
                            @foreach($preguntas as $pregunta)
                              <tr>
                                ...
                                <td class="relative whitespace-nowrap py-4 pl-3 pr-4 sm:pr-6">
                                  <div class="flex items-center">
                                      <a href="{{ route('frecuent-questions.edit', $pregunta->PreguntaFrecuenteID) }}">
                                      ...
                                      <div>
                                        <form action="{{ route('frecuent-questions.destroy', $pregunta->PreguntaFrecuenteID) }}" method="POST">
