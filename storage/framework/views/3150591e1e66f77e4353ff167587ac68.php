...
<?php $__env->startSection('content'); ?>
    ...
    <div class="max-w-screen-2xl w-full mx-auto px-4 sm:px-6 lg:px-8 px-4 sm:px-6 lg:px-8 mt-12">
        ...
        <form action="<?php echo e(route('events.show', 1)); ?>" method="get" class="flex items-center gap-5 w-full mt-12">
                            ...
                            <?php $__currentLoopData = $eventos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $evento): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <tr>
                                ...
                                <td class="w-1/4 whitespace-nowrap py-2 pl-4 pr-3 text-sm font-medium text-mundoVerdeGreen sm:pl-6 hover:underline">
                                  <a href="#"><?php echo e($evento->Nombre); ?></a>
                                </td>
                                <td class="w-1/4 max-w-xs sm:max-w-md whitespace-nowrap py-2 pl-4 pr-3 text-sm font-medium text-mundoVerdeGreen sm:pl-6 hover:underline overflow-hidden truncate">
                                  <span><?php echo e($evento->provincia->Nombre); ?></span>
                                </td>
                                <td class="w-1/4 whitespace-nowrap py-2 pl-4 pr-3 text-sm font-medium text-mundoVerdeGreen sm:pl-6 hover:underline">
                                ...
                                <td class="relative whitespace-nowrap py-4 pl-3 pr-4 sm:pr-6">
                                  <div class="flex items-center">
                                      <a href="<?php echo e(route('events.edit', $evento->EventoID)); ?>">
                                      ...
                                      <div>
                                        <form action="<?php echo e(route('events.destroy', $evento->EventoID)); ?>" method="POST">
...
<?php echo $__env->make('template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Turismo\resources\views/eventos/index.blade.php ENDPATH**/ ?>