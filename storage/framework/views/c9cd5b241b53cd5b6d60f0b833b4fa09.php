            ...
            <div class="bg-white rounded-md max-w-[65%] mx-auto">
                ...
                <div class="p-6 px-0 grid grid-cols-1 fieldsContainer">
                    ...
                    <div class="flex justify-between px-12 py-8 border-b border-gray-200">
                        ...
                        <div class="w-full">
                            <input type="text" name="Nombre" id="name" value="<?php echo e(old('Nombre')); ?>" class="w-full border border-gray-200 px-4 py-[8px] box-border rounded text-md" required>
                        </div>
                    </div>
                        ...
                        <div class="w-full">
                            <select name="TipoSitioID" id="Tipo" class="w-full border border-gray-200 px-4 py-[8px] box-border rounded text-md" required>
                                ...
                                <?php $__currentLoopData = $tipos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tipo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($tipo->TipoSitioID); ?>" <?php echo e(old('TipoSitioID') == $tipo->TipoSitioID ? 'selected' : ''); ?>><?php echo e($tipo->Nombre); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="flex justify-between px-12 py-8 border-b border-gray-200">
                        ...
                        <div class="w-full">
                            <textarea name="Descripcion" id="description" cols="30" rows="16" class="w-full min-h-[150px] border border-gray-200 px-4 py-[8px] box-border rounded text-md" required><?php echo e(old('Descripcion')); ?></textarea>
                        </div>
                    </div>
                    ...
                    <div class="flex justify-between px-12 py-8 border-b border-gray-200">
                        ...
                        <div class="w-full">
                            <input type="text" name="Latitud" id="latitud" value="<?php echo e(old('Latitud')); ?>"  class="w-full border border-gray-200 px-4 py-[8px] box-border rounded text-md">
                        </div>
                    </div>
                    ...
                    <div class="flex justify-between px-12 py-8 border-b border-gray-200">
                        ...
                        <div class="w-full">
                            <input type="text" name="Longitud" id="longitud" value="<?php echo e(old('Longitud')); ?>" class="w-full border border-gray-200 px-4 py-[8px] box-border rounded text-md">
                        </div>
                    </div>
                    ...
                    <div class="flex justify-between px-12 py-8 border-b border-gray-200">
                        ...
                        <div class="w-full">
                            <select name="Actividades[]" id="actividades" multiple="multiple" class="w-full border border-gray-200 px-4 py-[8px] box-border rounded text-md" required>
                                ...
                                <option value="<?php echo e($actividad->ActividadID); ?>" <?php if(in_array($actividad->ActividadID, old('Actividades', []))): ?> selected <?php endif; ?>><?php echo e($actividad->Nombre); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                    </div>
...
<?php echo $__env->make('template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Turismo\resources\views/lugares/create.blade.php ENDPATH**/ ?>