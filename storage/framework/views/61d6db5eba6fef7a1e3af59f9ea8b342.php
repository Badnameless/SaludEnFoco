...
<?php $__env->startSection('content'); ?>
    ...
    <div class="max-w-screen-2xl w-full mx-auto px-4 sm:px-6 lg:px-8 px-4 sm:px-6 lg:px-8 mt-12">
        ...
        <form action="<?php echo e(route('accommodations.show', 1)); ?>" method="get" class="flex items-center gap-5 w-full mt-12">
        ...
        <div class="bg-white rounded-md">
            <div class="mb-4 flex items-center justify-end px-8 pt-8">
                <a href="<?php echo e(route('accommodations.create')); ?>">
                      ...
                      <div class="overflow-hidden ring-1 ring-transparent ring-opacity-5">
                        <table class="min-w-full">
                          ...
                          <tbody id="tableBody" class="bg-white">
                            <!-- Odd row -->
                            <?php $__currentLoopData = $alojamientos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $alojamiento): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <tr>
                                ...
                                <td class="w-1/6 whitespace-nowrap py-2 pl-4 pr-3 text-sm font-medium text-mundoVerdeGreen sm:pl-6 hover:underline">
                                  <a href="#"><?php echo e($alojamiento->Nombre); ?></a>
                                </td>
                                <td class="w-1/6 whitespace-nowrap py-2 pl-4 pr-3 text-sm font-medium text-mundoVerdeGreen sm:pl-6 hover:underline">
                                    <a href="#"><?php echo e($alojamiento->provincia->Nombre); ?></a>
                                </td>
                                <td class="w-1/6 whitespace-nowrap py-2 pl-4 pr-3 text-sm font-medium text-mundoVerdeGreen sm:pl-6 hover:underline">
                                    <a href="#"><?php echo e($alojamiento->lugar->Nombre); ?></a>
                                </td>
                                ...
                                <td class=" w-1/6 relative whitespace-nowrap py-4 pl-3 pr-4 sm:pr-6">
                                  <div class="flex items-center">
                                      <a href="<?php echo e(route('accommodations.edit', $alojamiento->AlojamientoID)); ?>">
                                      ...
                                      <div>
                                        <form action="<?php echo e(route('accommodations.destroy', $alojamiento->AlojamientoID)); ?>" method="POST">
...
<?php echo $__env->make('template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Turismo\resources\views/alojamientos/index.blade.php ENDPATH**/ ?>