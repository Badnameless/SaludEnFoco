        ...
        <div class="bg-white rounded-md max-w-[65%] mx-auto">
            ...
            <div class="p-6 px-0 grid grid-cols-1 fieldsContainer">
                ...
                <div class="flex justify-between px-12 py-8 border-b border-gray-200">
                    ...
                    <div class="w-full">
                        <span class="border border-gray-200 px-4 py-[8px] box-border rounded text-md"><?php echo e($negocio->Nombre); ?></span>
                    </div>
                </div>
                <div class="flex justify-between px-12 py-8 border-b border-gray-200">
                    <label class="text-[16px] font-medium leading-thing mr-2 flex items-center w-[250px]" for="name">Provincia</label>
                    <div class="w-full">
                        <span class="border border-gray-200 px-4 py-[8px] box-border rounded text-md"><?php echo e($negocio->provincia->Nombre); ?></span>
                    </div>
                </div>
                <div class="flex justify-between px-12 py-8 border-b border-gray-200">
                    <label class="text-[16px] font-medium leading-thing mr-2 flex items-center w-[250px]" for="name">Sitio Turistico Cercano</label>
                    <div class="w-full">
                        <span class="border border-gray-200 px-4 py-[8px] box-border rounded text-md"><?php echo e($negocio->lugar->Nombre); ?></span>
                    </div>
                </div>
                ...
                <div class="flex justify-between px-12 py-8 border-b border-gray-200">
                    ...
                    <div class="w-full">
                        <span class="border border-gray-200 px-4 py-[8px] box-border rounded text-md"><?php echo e($negocio->Tipo); ?></span>
                    </div>
                </div>
                <!-- Campo Descripción -->
                <div class="flex justify-between px-12 py-8 border-b border-gray-200">
                ...
                <div class="flex justify-between px-12 py-8 border-b border-gray-200">
                    ...
                    <div class="w-full">
                        <span class="border border-gray-200 px-4 py-[8px] box-border rounded text-md"><?php echo e($negocio->Latitud); ?></span>
                    </div>
                </div>
                ...
                <div class="flex justify-between px-12 py-8 border-b border-gray-200">
                    ...
                    <div class="w-full">
                        <span class="border border-gray-200 px-4 py-[8px] box-border rounded text-md"><?php echo e($negocio->Longitud); ?></span>
                    </div>
                </div>
                ...
                <div class="flex justify-between px-12 py-8 border-b border-gray-200">
                    ...
                    <div class="w-full flex flex-wrap">
                        ...
                        <img src="<?php echo e(asset('storage/negocios/' . $imagen)); ?>" alt="<?php echo e($negocio->Nombre); ?>" class="mt-4 mb-4 mr-4 max-w-[200px]">
                ...
                <div class="flex justify-between px-12 py-8">
                    ...
                    <div class="w-full">
                        <span class="border border-gray-200 px-4 py-[8px] box-border rounded text-md">
                            <?php echo e($negocio->Estado ? 'Activo' : 'Inactivo'); ?>
...
<?php echo $__env->make('template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Turismo\resources\views/negocios/show.blade.php ENDPATH**/ ?>