...
<?php $__env->startSection('content'); ?>
    ...
    <div class="max-w-screen-2xl w-full mx-auto px-4 sm:px-6 lg:px-8 px-4 sm:px-6 lg:px-8 mt-12">
        <?php echo $__env->make('provincias.forms', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

        <?php if(session()->has('locale') && session()->get('locale') !== 'es'): ?>

         <?php echo $__env->yieldContent('provincias-edit-form-en'); ?>

        <?php else: ?>

         <?php echo $__env->yieldContent('provincias-edit-form-es'); ?>
...
<?php echo $__env->make('template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Turismo\resources\views/provincias/edit.blade.php ENDPATH**/ ?>