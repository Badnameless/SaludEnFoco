...
<?php $__env->startSection('content'); ?>
    ...
    <div class="max-w-screen-2xl w-full mx-auto px-4 sm:px-6 lg:px-8 px-4 sm:px-6 lg:px-8 mt-12">
        ...
        <form action="<?php echo e(route('provinces.show', 1)); ?>" method="get" class="flex items-center gap-5 w-full mt-12">
          ...
          <div class="bg-white rounded-md mb-8 w-full">
              ...
              <div class="w-full py-8 px-6 grid grid-cols-2 gap-10">
                  ...
                  <div class="mb-6 flex items-center">
                      ...
                      <input type="text" name="name" id="name" class="h-35px text-sm border border-labelFilterBorder rounded-r-md w-full px-4" <?php if(isset($_GET['name'])): ?> value="<?php echo e($_GET['name']); ?>" <?php endif; ?>>
                  </div>
        ...
        <div class="bg-white rounded-md">
            <div class="mb-4 flex items-center justify-end px-8 pt-8">
                <a href="<?php echo e(route('frecuent-questions.create')); ?>">
                        ...
                        <table class="min-w-full">
                          <thead class="bg-mundoVerdeGreen">
                            <tr>
                              ...
                              <th scope="col" class="py-2 pl-4 pr-3 text-left text-sm font-semibold text-white sm:pl-6">Pregunta</th>
                              <th scope="col" class="py-2 pl-4 pr-3 text-left text-sm font-semibold text-white sm:pl-6">Respuesta</th>
                              <th scope="col" class="py-2 pl-4 pr-3 text-left text-sm font-semibold text-white sm:pl-6">Index</th>
                            ...
                            <?php $__currentLoopData = $preguntas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pregunta): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <tr>
                                ...
                                <td class="w-1/4 whitespace-nowrap py-2 pl-4 pr-3 text-sm font-medium text-mundoVerdeGreen sm:pl-6 hover:underline">
                                  <a href="#"><?php echo e($pregunta->Pregunta); ?></a>
                                </td>
                                ...
                                <td class="relative whitespace-nowrap py-4 pl-3 pr-4 sm:pr-6">
                                  <div class="flex items-center">
                                      <a href="<?php echo e(route('frecuent-questions.edit', $pregunta->PreguntaFrecuenteID)); ?>">
                                      ...
                                      <div>
                                        <form action="<?php echo e(route('frecuent-questions.destroy', $pregunta->PreguntaFrecuenteID)); ?>" method="POST">

                                          <?php echo csrf_field(); ?>
                                          <?php echo method_field('DELETE'); ?> 

                                        <div>
                                            <button class="w-35px h-35px cursor-pointer text-gray-500 flex items-center text-sm justify-center rounded-full hover:bg-red-600 hover:text-white duration-300" type="submit" onclick="return confirm('¿Seguro que desea eliminar la provincia?')"><i class="far fa-trash-alt"></i></button>
                                        </div>
                                        </form> 
...
<?php echo $__env->make('template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Turismo\resources\views/preguntasfrecuentes/index.blade.php ENDPATH**/ ?>