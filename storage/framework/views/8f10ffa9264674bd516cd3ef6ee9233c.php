        ...
        <div class="bg-white rounded-md max-w-[65%] mx-auto">
            ...
            <div class="p-6 px-0 grid grid-cols-1 fieldsContainer">
                ...
                <div class="flex justify-between px-12 py-8 border-b border-gray-200">
                    ...
                    <div class="w-full">
                        <span class="border border-gray-200 px-4 py-[8px] box-border rounded text-md"><?php echo e($lugar->Nombre); ?></span>
                    </div>
                </div>
                <!-- Campo ProvinciaID -->
                <div class="flex justify-between px-12 py-8 border-b border-gray-200">
                    ...
                    <div class="w-full">
                        <span class="border border-gray-200 px-4 py-[8px] box-border rounded text-md"><?php echo e($lugar->provincia->Nombre); ?></span>
                    </div>
                </div>
                <!-- Campo Descripción -->
                <div class="flex justify-between px-12 py-8 border-b border-gray-200">
                ...
                <div class="flex justify-between px-12 py-8 border-b border-gray-200">
                    ...
                    <div class="w-full">
                        <span class="border border-gray-200 px-4 py-[8px] box-border rounded text-md"><?php echo e($lugar->Tipo); ?></span>
                    </div>
                </div>
                <!-- Campo Latitud -->
                <div class="flex justify-between px-12 py-8 border-b border-gray-200">
                    ...
                    <div class="w-full">
                        <span class="border border-gray-200 px-4 py-[8px] box-border rounded text-md"><?php echo e($lugar->Latitud); ?></span>
                    </div>
                </div>
                <!-- Campo Longitud -->
                <div class="flex justify-between px-12 py-8 border-b border-gray-200">
                    ...
                    <div class="w-full">
                        <span class="border border-gray-200 px-4 py-[8px] box-border rounded text-md"><?php echo e($lugar->Longitud); ?></span>
                    </div>
                </div>
                <!-- Campo Actividades -->
                <div class="flex justify-between px-12 py-8 border-b border-gray-200">
                ...
                <div class="flex justify-between px-12 py-8 border-b border-gray-200">
                    <div class="bodyContainer__productData--table-inputs-input flex items-center mb-4 pr-4 max-w-xl w-full">
                        ...
                        <div class="w-full">
                            ...
                            <?php echo e($lugar->Estado ? 'Activo' : 'Inactivo'); ?>
...
<?php echo $__env->make('template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Turismo\resources\views/lugares/show.blade.php ENDPATH**/ ?>