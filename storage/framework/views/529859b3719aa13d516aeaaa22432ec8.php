...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(config('app.url')); ?>/css/styles.css">
...
-->
        ...
        <div class="hidden lg:flex lg:w-64 lg:flex-col lg:fixed lg:inset-y-0">
            ...
            <div class="flex flex-col flex-grow bg-mundoVerdeGreen pt-5 pb-4 overflow-y-auto">
                <div class="flex items-center flex-shrink-0 px-4 mb-6">
                    <img class="w-32" src="<?php echo e(url('/images/pageLogo.png')); ?>" alt="Easywire logo">
                </div>
                    ...
                    <div class="space-y-1 grid grid-rows-3 items-between h-full">
                        ...
                        <div class="row-span-2 linksCatContainer">
                            ...
                            <a href="<?php echo e(route('provinces.index')); ?>"
                                ...
                                aria-current="page">
                                <!-- Heroicon name: outline/home -->
                                <img class="h-23px mr-4" src="<?php echo e(url('/images/white-online-order.png')); ?>"
                                    alt="">
                                Provincias
                            </a>
                            <a href="<?php echo e(route('places.index')); ?>"
                                class="sites navLink -mr-2 rounded-r-none hover:bg-gradient-to-r from-gray-600 text-white group flex items-center pl-6 py-2 text-lg !mb-2 box-border w-full leading-6 font-normal"
                                aria-current="page">
                                <!-- Heroicon name: outline/home -->
                                <img class="h-23px mr-4" src="<?php echo e(url('/images/calendar.png')); ?>" alt="">
                                Sitios Turísticos
                            </a>

                            <a href="<?php echo e(route('accommodations.index')); ?>"
                                class="alojamientos navLink -mr-2 rounded-r-none hover:bg-gradient-to-r from-gray-600 text-white group flex items-center pl-6 py-2 text-lg !mb-2 box-border w-full leading-6 font-normal"
                                aria-current="page">
                                <!-- Heroicon name: outline/home -->
                                <img class="h-23px mr-4" src="<?php echo e(url('/images/logistic.png')); ?>" alt="">
                                Alojamientos
                            </a>
                            
                            <a href="<?php echo e(route('events.index')); ?>"
                                class="eventos navLink -mr-2 rounded-r-none hover:bg-gradient-to-r from-gray-600 text-white group flex items-center pl-6 py-2 text-lg !mb-2 box-border w-full leading-6 font-normal"
                                aria-current="page">
                                <!-- Heroicon name: outline/home -->
                                <img class="h-23px mr-4" src="<?php echo e(url('/images/calendar.png')); ?>" alt="">
                                Eventos
                            ...
                            <a href="<?php echo e(route('guides.index')); ?>"
                                class="guias navLink -mr-2 rounded-r-none hover:bg-gradient-to-r from-gray-600 text-white group flex items-center pl-6 py-2 text-lg !mb-2 box-border w-full leading-6 font-normal"
                                aria-current="page">
                                <!-- Heroicon name: outline/home -->
                                <img class="h-23px mr-4" src="<?php echo e(url('/images/white-settings.png')); ?>"
                                    alt="">
                                Guias Turisticos
                            </a>

                            <a href="<?php echo e(route('business.index')); ?>"
                                class="negocios navLink -mr-2 rounded-r-none hover:bg-gradient-to-r from-gray-600 text-white group flex items-center pl-6 py-2 text-lg !mb-2 box-border w-full leading-6 font-normal"
                                aria-current="page">
                                <!-- Heroicon name: outline/home -->
                                <img class="h-23px mr-4" src="<?php echo e(url('/images/white-new-product.png')); ?>"
                                    alt="">
                                Negocios
                            </a>

                            <a href="<?php echo e(route('frecuent-questions.index')); ?>"
                                class="guias navLink -mr-2 rounded-r-none hover:bg-gradient-to-r from-gray-600 text-white group flex items-center pl-6 py-2 text-lg !mb-2 box-border w-full leading-6 font-normal"
                                aria-current="page">
                                <!-- Heroicon name: outline/home -->
                                <img class="h-23px mr-4" src="<?php echo e(url('/images/computer.png')); ?>"
                                    alt="">
                        ...
                        <div class="h-60px bg-white flex-1 items-center flex justify-between p-4 py-3 rounded-2xl">
                            ...
                            <div class="flex items-center ml-auto mr-auto">
                              ...
                              <?php $__currentLoopData = $languages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $code => $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                  <a href="<?php echo e(route('cambiar-idioma', ['locale' => $code])); ?>">
                                      <button type="button" class="px-4 py-2 rounded text-sm mr-4 hover:bg-gray-300 duration-300"><?php echo e($name); ?></button>
                                  </a>
                            ...
                            <form method="POST" action="<?php echo e(route('logout')); ?>">
                                ...
                                <a href="<?php echo e(route('logout')); ?>"
                                    ...
                                    <div
                                        ...
                                        <img class="h-6 w-6" src="<?php echo e(url('/images/power-off.png')); ?>" alt="">
                                    </div>
                                </a>
                            </form>
                        <?php endif; ?>
    ...
    <script src="<?php echo e(config('app.url')); ?>/js/graphics.js"></script>
    <script src="<?php echo e(config('app.url')); ?>/js/analytics.js"></script>
    <script>
...
<?php /**PATH C:\laragon\www\Turismo\resources\views/template.blade.php ENDPATH**/ ?>