        ...
        <form action="<?php echo e(route('guides.store')); ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="bg-white rounded-md max-w-[65%] mx-auto">
                ...
                <div class="flex justify-between px-12 py-8 border-b border-gray-200">
                    ...
                    <div class="w-full">
                        <input type="text" required name="Telefono" value="<?php echo e(old('Telefono')); ?>" class="w-full border border-gray-200 px-4 py-[8px] box-border rounded text-md">
                    </div>
                </div>
                ...
                <div class="flex justify-between px-12 py-8 border-b border-gray-200">
                    ...
                    <div class="w-full">
                        <textarea name="Experiencias" id="experiencias" cols="30" rows="4" class="w-full min-h-[80px] border border-gray-200 px-4 py-[8px] box-border rounded text-md"><?php echo e(old('Experiencias')); ?></textarea>
                    </div>
                </div>
...
<?php echo $__env->make('template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Turismo\resources\views/guias/create.blade.php ENDPATH**/ ?>