        ...
        <form action="<?php echo e(route('business.store')); ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="bg-white rounded-md max-w-[65%] mx-auto">
                ...
                <div class="flex justify-between px-12 py-8 border-b border-gray-200">
                    ...
                    <div class="w-full">
                        <input type="text" required name="Nombre" id="nombre" value="<?php echo e(old('Nombre')); ?>" class="w-full border border-gray-200 px-4 py-[8px] box-border rounded text-md">
                    </div>
                </div>
                ...
                <div class="flex justify-between px-12 py-8 border-b border-gray-200">
                    ...
                    <div class="w-full">
                        <input type="text" required name="Lugar" id="Lugar" value="<?php echo e(old('Lugar')); ?>" class="w-full border border-gray-200 px-4 py-[8px] box-border rounded text-md">
                    </div>
                </div>
                ...
                <div class="flex justify-between px-12 py-8 border-b border-gray-200">
                    ...
                    <div class="w-full">
                        ...
                        $TipoNes = Tiponegocio::all();
                        ?>
                        <select name="Tipo" id="Tipo" class="w-full border border-gray-200 px-4 py-[8px] box-border rounded text-md">
                            <?php $__currentLoopData = $TipoNes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $TipoNe): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($TipoNe->Nombre); ?>" <?php if(old('Tipo') == $TipoNe->Nombre): ?> selected <?php endif; ?>><?php echo e($TipoNe->Nombre); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                </div>
                ...
                <div class="flex justify-between px-12 py-8 border-b border-gray-200">
                    ...
                    <div class="w-full">
                        <textarea name="Descripcion" id="descripcion" cols="30" rows="4" class="w-full min-h-[80px] border border-gray-200 px-4 py-[8px] box-border rounded text-md"></textarea>
                    </div>
                </div>
...
<?php echo $__env->make('template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Turismo\resources\views/negocios/create.blade.php ENDPATH**/ ?>